...
`Standard liquid filters <https://github.com/Shopify/liquid/wiki/Liquid-for-Designers#standard-filters>`_ are available out of box.
...
.. container:: ptable
   ...
   Example                                           Result
   ================================================= ======================
   ``{{ "red" | color_to_hex }}``                    ``rgb(255, 0, 0)``
   ``{{ "#fefefe" | color_to_hex }}``                ``rgb(254, 254, 254)``
   ``{{ "rgb(255, 0, 255)" | color_to_hex }}``       ``rgb(255, 0, 255)``
   ``{{ "rgba(255, 0, 255, 0.1)" | color_to_hex }}`` ``rgb(255, 0, 255)``
   ================================================= ======================
