...
2. **Create a Partial**: Click on the `Create Partial` button. This will open a new form where you can define your partial.
    ...
    - **Type**: Select the type of partial you are creating. This can be either `HTML` or `CSS`.
...
2. **Include the Partial in a Main Template**:
...
.. seealso::
   - `Liquid Partials documentation <https://liquidjs.com/tutorials/partials-and-layouts.html/>`_
