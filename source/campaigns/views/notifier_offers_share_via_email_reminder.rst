...
1. Main email sending criteria (unable to change):
   ...
   1. If |friend| offer is active
   2. Recipient (|friend|) was not referred by this offer yet
   3. Current offer is the last one shared with the recipient (if were delayed few reminders Talkable sends the last one)
