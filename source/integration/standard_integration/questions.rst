.. _integration/standard_integration/questions:
...
1. :ref:`Does the post purchase script need to capture all purchases or just
   Talkable purchases? <integration/standard_integration/questions/post_purchase_capture>`

2. :ref:`How does referral tracking work? <integration/standard_integration/questions/how_does_referral_tracking_work>`

3. :ref:`What does the Talkable integration do? <integration/standard_integration/questions/what_does_the_talkable_integration_do>`

4. :ref:`How does Talkable know where to display content? <integration/standard_integration/questions/talkable_know_where_to_display_content>`

5. :ref:`What do I, as a developer, need to do to complete integration? <integration/standard_integration/questions/complete_integration>`

6. :ref:`How does the rewarding process work? <integration/standard_integration/questions/rewarding_process_work>`

7. :ref:`How do I verify success? <integration/standard_integration/questions/verify_success>`

.. _integration/standard_integration/questions/post_purchase_capture:
...
.. _integration/standard_integration/questions/how_does_referral_tracking_work:
...
.. _integration/standard_integration/questions/what_does_the_talkable_integration_do:
...
.. _integration/standard_integration/questions/talkable_know_where_to_display_content:
...
.. _integration/standard_integration/questions/complete_integration:
...
.. _integration/standard_integration/questions/rewarding_process_work:
...
.. _integration/standard_integration/questions/verify_success:

**7. How do I verify success?**

Refer to the section titled :ref:`Validating the Integration <integration/standard_integration/validating_integration>`.
