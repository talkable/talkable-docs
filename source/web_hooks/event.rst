...
The sample payload with parameters for Event Webhook is available here: `Event Webhook Payload <https://www.talkable.com/api-docs/index.html?urls.primaryName=Webhooks#/Event%20Webhook/post_yourApiEventWebhookPath>`_.
